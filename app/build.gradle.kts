...
android {
    namespace = "com.example.medicalappointmentcompanion"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.medicalappointmentcompanion"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    // Use whichever NDK is installed - install via SDK Manager if needed
    // Recommended: NDK 25.x or 26.x
